...
class ObservabilityTests(FoundationTestCase):
    ...
    def test_critical_metrics_reconstruct_from_database(self):
        ...
        repository.add_raw_event(subject_id="sub_00000000", device_id="dev_00000000", ingest_id="ing_11111111111111111111", idempotency_key="1" * 64, source_digest="1" * 64, payload=b"{}", received_at_ms=9000, captured_at_ms=None, source_type="status")
        ...
        self.assertIn("hermodr_worst_ingest_age_seconds 1", rendered)
