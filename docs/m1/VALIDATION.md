...
The final release-candidate run passed 41 tests and measured **100.00% line coverage (1847/1847 executable lines)**. The gate fails at 95% or below and measures all handwritten Python runtime, build-backend, harness, SQLite supply, static-analysis, and test code.
